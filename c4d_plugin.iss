...
Source: "plugin\R20\*"; DestDir: "{code:R20Dir|plugins/{#MyDirName}}"; Components:R20; Flags: ignoreversion createallsubdirs recursesubdirs; 
Source: "plugin\R21\*"; DestDir: "{code:R21Dir|plugins/{#MyDirName}}"; Components:R21; Flags: ignoreversion createallsubdirs recursesubdirs; 
Source: "plugin\S22\*"; DestDir: "{code:S22Dir|plugins/{#MyDirName}}"; Components:S22; Flags: ignoreversion createallsubdirs recursesubdirs; 
Source: "plugin\R23\*"; DestDir: "{code:R23Dir|plugins/{#MyDirName}}"; Components:R23; Flags: ignoreversion createallsubdirs recursesubdirs; 
Source: "plugin\S24\*"; DestDir: "{code:S24Dir|plugins/{#MyDirName}}"; Components:S24; Flags: ignoreversion createallsubdirs recursesubdirs; 
Source: "plugin\R25\*"; DestDir: "{code:R25Dir|plugins/{#MyDirName}}"; Components:R25; Flags: ignoreversion createallsubdirs recursesubdirs; 

Source: "plugin\common\*"; DestDir: "{code:R20Dir|plugins\{#MyDirName}}"; Components:R20; Flags: ignoreversion createallsubdirs recursesubdirs; 
Source: "plugin\common\*"; DestDir: "{code:R21Dir|plugins\{#MyDirName}}"; Components:R21; Flags: ignoreversion createallsubdirs recursesubdirs; 
Source: "plugin\common\*"; DestDir: "{code:S22Dir|plugins\{#MyDirName}}"; Components:S22; Flags: ignoreversion createallsubdirs recursesubdirs; 
Source: "plugin\common\*"; DestDir: "{code:R23Dir|plugins\{#MyDirName}}"; Components:R23; Flags: ignoreversion createallsubdirs recursesubdirs; 
